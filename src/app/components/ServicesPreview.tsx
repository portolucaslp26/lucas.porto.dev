...
const services = [
  ...
  },
  {
    ...
    desc: 'Sistemas que se conversam é economia de dinheiro e tempo. Conecto seus ERPs, CRMs, pagamentos e ferramentas.',
    ...
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <AnimateOnScroll direction="up" delay={100} threshold={0.05}>
            <div className="service-card md:col-span-2 rounded-2xl p-8 flex flex-col justify-between min-h-56">
              <div className="flex items-start justify-between">
                <div>
          ...
          <AnimateOnScroll direction="up" delay={100} threshold={0.05}>
            <div className="service-card md:col-span-2 rounded-2xl p-8 flex flex-col justify-between min-h-56">
              <div className="flex items-start justify-between">
                <div>
                  <span className="section-label text-[0.55rem] block mb-4">{services[4].label}</span>
                  <h3 className="font-mono font-bold text-2xl text-foreground mb-3">{services[4].title}</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">{services[4].desc}</p>
                </div>
                <div className="w-12 h-12 border border-accent/30 rounded-lg flex items-center justify-center shrink-0 ml-4 bg-accent/5">
